...
cv2.imshow("Original Image", natureImage)

# Create a rectangle mask
maskImage = cv2.rectangle(np.zeros(natureImage.shape[:2], dtype='uint8'), (50, 50),
                          (int(natureImage.shape[1]-50), int(natureImage.shape[1]/2-50)), (255, 255, 255),  -1)
